...
-- Fire Empowered Duke is 100% immune to all 10 damage types (see monster.elements below) while in
-- this transformed state - it reverts to the normal, killable "The Duke of the Depths" type once
-- all 5 Fiery Hearts are cleared (creaturescripts_fiery_heart.lua), so this form's loot table is
-- never actually reachable through combat. Cleared the pre-existing copy-pasted, thematically
-- unrelated minotaur loot table (gold ingot/minotaur leather/execowtioner mask/butcher's axe/etc.)
-- for correctness even though it was functionally inert.
monster.loot = {}
