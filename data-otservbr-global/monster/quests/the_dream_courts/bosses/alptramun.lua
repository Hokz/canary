...
monster.attacks = {
	...
	{ name = "alptramun summon", interval = 4000, chance = 15, target = false }, -- CONFIRMED BUG (pre-existing): fully scripted dream-tier summon spell, never referenced in this attacks table
}
