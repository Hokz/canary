...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "foresight of authorities") and npcHandler:getTopic(playerId) == 1 then
	...
	elseif MsgContains(message, "trouble will arise in near future") and npcHandler:getTopic(playerId) == 3 then
