...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "fight") then
		if player:getStorageValue(Storage.Quest.U12_00.TheDreamCourts.Main.TheWinterCourt) == 1 then
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 2 then
			...
			player:setStorageValue(Storage.Quest.U12_00.TheDreamCourts.DreamScarCurrentFaction, 2)
