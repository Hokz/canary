-- Aura of Sapped Strength (15.25.3a4a52). Sorcerer crippling stance, level 175, 1500 mana. See
...
function spell.onCastSpell(creature, variant)
	return Stance.cast(creature, AttrSubId_StanceSappedStrength, Stance.Family.Crippling, build, CONST_ME_MORTAREA)
end
